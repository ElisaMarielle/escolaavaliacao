...
4. Para rodar o back-end há duas maneiras:
   <br>a) Se estiver na pasta "escolaavaliacao", digite no terminal `cd api` e dê enter. Ao checar que está dentro da pasta correta, basta rodar o server por `npm run dev` ou `node server.js`;
   <br>b) Se já estiver na pasta API, basta rodar o server usando um dos comandos anteriores (`npm run dev` ou `node server.js`).
...
|---|---|---|---|
| ![login](docs/index.png)  | ![login](docs/inicio.png)  | ![login](docs/aulas.png)  | ![login](docs/modal.png)  |